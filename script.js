/* ══════════════════════════════════════════
   HARITHA BUDDIGA — Portfolio Script
...
(function initTyped() {
  ...
  const words   = ['BSc CS Student', 'Python Developer', 'AI Enthusiast', 'Cloud Specialist', 'Problem Solver'];
  let wi        = 0;
  let ci        = 0;
  let deleting  = false;
...
// Console easter egg
console.log(
  '%c < HB /> %cHaritha Buddiga · BSc CS Student · AI & Cloud',
